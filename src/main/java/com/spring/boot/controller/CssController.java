...
public class CssController {
	@GetMapping("/css/list")
	public String cssList(HttpServletRequest request, ModelMap modelMap) {
		log.info("cssList");
		...
		try {
			...
			Path rootDir = Paths.get("src/main/resources/static/css");
...
//					log.info("fileName : {}", fileName);
				...
				.forEach(item -> {
					...
					String replacePath = orgPath.replace("src\\main\\resources\\static\\css\\", "");
		...
		log.info("cssList : {}", arrayList);
		
		modelMap.addAttribute("page", "fragments/css/cssList");
